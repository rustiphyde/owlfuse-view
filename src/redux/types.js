...
export const SET_INFERNAL = 'SET_INFERNAL';
export const ADD_INFERNAL_STOKE = 'ADD_INFERNAL_STOKE';
export const ADD_INFERNAL_HEAT = 'ADD_INFERNAL_HEAT';
export const REMOVE_INFERNAL_HEAT = 'REMOVE_INFERNAL_HEAT';
export const EXTINGUISH_INFERNAL = 'EXTINGUISH_INFERNAL';